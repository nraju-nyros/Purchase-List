...
const CompleteDispatchNotification = () => {
  ...
  return (
    <SideDrawer
      ...
      title="Complete Dispatch Notification"
      ...
      <Row>
        <Col span={showHelpModal ? 20 : 24}>
          ...
          {renderStepBar(current)} 
              ...
              <div style={{ background: "#F3F5F8" }} className="flex flex-col ">
                <div className="content rounded-lg px-40 flex-grow pb-10">
                  <Card className=" rounded-2xl">
                    <div className="px-8 pt-8 pb-10">
                      <h5 class="font-poppins z-10 text-h1 font-semibold leading-normal text-pickled-bluewood pb-2">
                        Return Date & Time
                      </h5>
                        ...
                        <Col span={6}>
                          <div className="input_text_color">
                            ...
                            <CustomInput
                              ...
                              requiredField={true}
                              onChange={(val) =>
                                setFieldValue("Measurements", val)
                              }
                              error={
                        ...
                        <Col span={3}>
                          <div className="input_text_color">
                            ...
                            <CustomInput
                              ...
                              error={
                                touched.Units && errors.Units && errors.Units
                              }
                            />
                          </div>
                        </Col>
            ...
            >
              ...
              <div className="mt-3">
                <p>
                  Are you sure you want to Complete Dispatch
                  <br /> notification for Equipment No.1016484795?
                </p>
              </div>
            ...
            >
              <div>
                <h6 className="font-bold mt-1">
                  Enter Split Management - Miles Travelled{" "}
                </h6>
                <br />
                <Row gutter={50}>
                  <Col span={10}>
...
export default CompleteDispatchNotification;
