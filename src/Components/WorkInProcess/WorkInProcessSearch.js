...
export const WorkInProcessSearch = ({
    ...
    const getAllOptionList = () => {
        ...
        console.log("printing tempOptionList inside getAllOptionList ",tempOptionList)
    ...
    const [optionList, setOptionList] = useState(getAllOptionList());
      ...
      const fetchOptionList = (optionListName, optionList) => {
        ...
        console.log("printing optionList with optionKeys inside fetchOptionList ",optionList[optionListName])
      };
      ...
      const formik = useFormik({
        initialValues: {
          ...
          startDate: advanceFilterData?.startDate ? advanceFilterData?.startDate : "",
                              ...
                              {inputs.map((input) => {
                                if (input.type == "customInput") {
                                  ...
                                  return (
                                    <>
                                      <Col span={24}>
                                        <h6 class="font-poppins z-10 text-h1 
                                        font-semibold leading-normal text-pickled-bluewood pb-2}">Date range</h6>
                                        <div className="flex py-3 items-center">
                                          ...
                                          <span className="mx-2 font-poppins font-medium 
                                          text-xs text-regent-gray leading-normal">to</span>
                                          <div className="notification-form-right ">
                                            <DatePicker
                                              ...
                                              onChange={(_date) => {
                                                setFieldValue("endDate", moment(_date._d).format("L"))
                                              }}
                                            />
                                          </div>
                                        </div>
                                  ...
                                  return (
                                    <>
                                      <Col span={24}>
                                        <div className="notification-form-right ">
                                          <div className="font-poppins z-10 text-h1 font-normal leading-normal text-pickled-bluewood pt-2 ">{input.label}</div>
                                          <CustomSwitchToggle
                                            ...
                                            offText="No"
                                            value={values[input.variable]}
                                            onChange={(val) => setFieldValue(input.variable, val)}
                                          />
                                        </div>
                                      </Col>
                                    </>
